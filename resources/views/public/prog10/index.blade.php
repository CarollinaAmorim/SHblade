  ...
  <div id="contenuto" class="visible">
    <article class="contenuti_descrizione">
      <header>
        ...
        <h1>Ap. Aline e Frederico<a href="{{route('public.progetto_11')}}" title="vai ao pr&amp;oacute;ximo projeto" class="fa fa-chevron-right"></a><a href="{{route('public.progetto_9')}}" title="volta ao projeto anterior" class="fa fa-chevron-left"></a>
        </h1>
