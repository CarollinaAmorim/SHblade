  ...
  <div id="contenuto" class="visible">
    <article class="contenuti_descrizione">
      <header>
        ...
        <h1>Ap. Bairro Buritis<a href="{{route('public.progetto_10')}}" title="vai ao pr&amp;oacute;ximo projeto" class="fa fa-chevron-right"></a><a href="{{route('public.progetto_8')}}" title="volta ao projeto anterior" class="fa fa-chevron-left"></a>
        </h1>
        ...
        <h3>Varanda e Lavanderia
        </h3>
      </header>
      <div class="filetto"></div>
      <p>Desenvolver projeto de reforma e ambientaçao da casa do casal, valorizando o espaço e dando mais personalidade aos ambientes<br/><br/><span class="desc"><span class="bold">Conceito:</span> Pernas para o ar.<br/><span class="bold">Caracteristicas essenciais:</span> praticidade, aconchego, arejado, espaçoso, despojado.<br/><span class="bold">Demandas:</span> Ambienta&ccedil;&atilde;o da sala, cozinha e varanda. Design de m&oacuteveis, iluminaçao.</span>
      </p>
    </article>
  </div>
